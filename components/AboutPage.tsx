    ...
    return (
        <div className="container mx-auto p-4 lg:p-8">
            <div className="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-8 md:p-12">
                <h1 className="text-4xl font-extrabold text-blue-600 dark:text-blue-400 mb-6 text-center">About Sparkly Detergents</h1>
                <div className="prose prose-lg dark:prose-invert max-w-4xl mx-auto text-slate-600 dark:text-slate-300">
                    <p>
                    ...
                    <h2 className="text-2xl font-bold text-slate-700 dark:text-slate-200 mt-8">Our Mission</h2>
                    <p>
